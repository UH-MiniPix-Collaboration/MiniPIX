...
plot(km, flightdataset$LIGHT_TRACK[1:1700],col = 1, ylab = "Number of Clusters", xlab = "Altitude (km)",type="h")
...
points(km, flightdataset$SMALL_BLOB[1:1700],col = 3,type="h")
points(km, flightdataset$STRAIGHT_TRACK[1:1700],col = "yellow", type="h")
points(km, flightdataset$HEAVY_TRACK[1:1700],col = "orange", type="h")
points(km, flightdataset$HEAVY_BLOB[1:1700],col = 2, type="h")
points(km, flightdataset$MEDIUM_BLOB[1:1700],col = "blue", type="h")