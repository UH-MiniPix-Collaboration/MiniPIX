...
%START: changes due to Guzik's recommendations - this following statement needs rework
...
%END
%%%START Guzik Changes:  Addition to background
...
%%%START Guzik Changes: We need to include more background on the MiniPIX
...
During the High Altitude Student Platform (HASP) 2017 and 2018 flights \cite{hasp}, the SORA payloads carried a MiniPIX interfaced with a Raspberry Pi 3 B+ (RPI) Single Board Computer (CITE ME%https://www.raspberrypi.org/)
