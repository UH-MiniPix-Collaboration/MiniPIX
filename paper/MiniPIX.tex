...
\author{S.~Oliver\fnref{label3}}
\author{S.~A.~Garcia~Morelos\fnref{label4}}
\author{K.~D.~Portillo\fnref{label5}}
\author{R.~B.~Masek\fnref{label6}}
\author{F.~Brooks\fnref{label7}}
\author{S.~George\fnref{label8}}
\author{D.~Pattison\fnref{label9}}
