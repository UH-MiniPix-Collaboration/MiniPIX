...
\author{A.~Walker\corref{cor4}\fnref{label2}}
\author{S.~Oliver\corref{cor3}\fnref{label3}}
\author{S.~A.~Garcia~Morelos\corref{cor1}\fnref{label4}}
\author{K.~D.~Portillo\corref{cor5}\fnref{label5}}
\author{R.~B.~Masek\corref{cor6}\fnref{label6}}
\author{F.~Brooks\corref{cor2}\fnref{label7}}
