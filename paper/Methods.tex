...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\textwidth]{Minipix_case_assembly.pdf} %REVIEW 1 from Renshaw: It might be useful to make this a side-by-side figure, with the second figure being a CAD drawing or picture of the payload showing the placement of the RPI and the MiniPIX, along with the other components. 
